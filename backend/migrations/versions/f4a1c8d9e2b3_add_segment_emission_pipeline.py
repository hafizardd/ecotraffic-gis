...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("raw_criteria", sa.JSON(), nullable=False), sa.Column("normalized_criteria", sa.JSON(), nullable=False), sa.Column("decision_score", sa.Float(), nullable=True), sa.Column("priority", sa.String(20), nullable=True), sa.Column("spatial_criteria_status", sa.String(30), nullable=False), sa.Column("ahp_metadata", sa.JSON(), nullable=False),
