...
import { CAMERA_TIER_COLORS, activityGradientCss, interventionGradientCss, MAP_MODES, type MapMode } from "@/constants/mapColors";
...
export default function MapLegend({ mode, segmentBuckets, cameraHistorical = 0, cameraTotal, activityBreaks }: MapLegendProps) {
                    ...
                    {mode === "traffic" && (
                        <>
                            ...
                            <section className="map-legend-section">
                                ...
                                <p className="legend-note">{cameraTotal} kamera{cameraHistorical > 0 ? ` · ${cameraHistorical} data statis` : ""}</p>
                            </section>
                        </>
                    )}
                    {mode === "potential" && (
